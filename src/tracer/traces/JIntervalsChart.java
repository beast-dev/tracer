 ...
 * In the process of being removed - JChart should not be extended
 * for specific plots.
 */
@Deprecated
...
//        int modeIndex = fc.getKeyIndex(td.getMode());
//        td.
//
...
//        float xRight2 = 0;
//        float y2 = 0;
//        for (Object key : fc.getUniqueValues()) {
//            float halfwidth = (float) (0.2 * fc.getProportionalFrequency(key));
//
//            int index = fc.get(key);
//            float x = (float) transformX(i + 1);
