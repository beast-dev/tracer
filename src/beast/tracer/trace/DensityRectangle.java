...
public class DensityRectangle {
    ...
    beast.tracer.trace.DensityRectangle[] quadrants = null;
        ...
        if (contains(point)) {
            ...
            if (quadrants == null) {
                ...
                if (points.size() > THRESHOLD) {
                    ...
                    quadrants = new beast.tracer.trace.DensityRectangle[4];
                    ...
                    quadrants[0] = new beast.tracer.trace.DensityRectangle(x, y, w, h);
                    quadrants[1] = new beast.tracer.trace.DensityRectangle(x + w, y, w, h);
                    quadrants[2] = new beast.tracer.trace.DensityRectangle(x, y + h, w, h);
                    quadrants[3] = new beast.tracer.trace.DensityRectangle(x + w, y + h, w, h);
    ...
    public static void main(String[] args) throws IOException, TraceException {
        ...
        final beast.tracer.trace.DensityRectangle densityRectangle = new beast.tracer.trace.DensityRectangle(0, 0, width, height);
