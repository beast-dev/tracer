...
package beast.tracer.trace;

import beast.tracer.trace.LogFileTraces;
import beast.tracer.trace.TraceDistribution;
import beast.tracer.trace.TraceException;
import beast.tracer.trace.TraceList;
import dr.util.*;
import dr.xml.*;
...
public class CnCsPerSiteAnalysis implements Citable {
    ...
    private String toStringSite(int index, OutputFormat format) {
        ...
        beast.tracer.trace.TraceDistribution distributionCN = traceListN.getDistributionStatistics(index);
        beast.tracer.trace.TraceDistribution distributionCS = traceListS.getDistributionStatistics(index);
        beast.tracer.trace.TraceDistribution distributionUN = traceListN.getDistributionStatistics((traceListN.getTraceCount()/2) + index);
    ...
    public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
        ...
        public Object parseXMLObject(XMLObject xo) throws XMLParseException {
            ...
            try {
                ...
                beast.tracer.trace.CnCsPerSiteAnalysis analysis = new beast.tracer.trace.CnCsPerSiteAnalysis(tracesCN,tracesCS);
...
//                analysis.setProportion(xo.getAttribute(PROPORTION, 0.95));
        ...
        public Class getReturnType() {
            return beast.tracer.trace.CnCsPerSiteAnalysis.class;
        }
