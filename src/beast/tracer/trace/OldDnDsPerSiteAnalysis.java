    ...
    public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
        ...
        public Object parseXMLObject(XMLObject xo) throws XMLParseException {
            ...
            try {
                ...
                beast.tracer.trace.OldDnDsPerSiteAnalysis analysis = new beast.tracer.trace.OldDnDsPerSiteAnalysis(samples[COND_S], samples[UNCOND_S],
        ...
        public Class getReturnType() {
            return beast.tracer.trace.OldDnDsPerSiteAnalysis.class;
        }
