...
import beast.tracer.trace.Filter;
import beast.tracer.trace.TraceCorrelation;
import beast.tracer.trace.TraceType;
...
//    public static final int INCREMENT_SIZE = 1000;
    ...
    protected beast.tracer.trace.TraceType traceType = beast.tracer.trace.TraceType.REAL;
...
//    private Object[] range;
    ...
    public Trace(String name, beast.tracer.trace.TraceType traceType) {
        this.name = name;
...
//    }
    ...
    public beast.tracer.trace.TraceType getTraceType() {
        return traceType;
    }
