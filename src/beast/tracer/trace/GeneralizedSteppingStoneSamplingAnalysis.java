    ...
    public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
    	...
    	public Object parseXMLObject(XMLObject xo) throws XMLParseException {
    		...
    		try {
                ...
                beast.tracer.trace.GeneralizedSteppingStoneSamplingAnalysis analysis = new beast.tracer.trace.GeneralizedSteppingStoneSamplingAnalysis(sourceName, destinationName, sampleTheta, sampleSource, sampleDestination);
        ...
        public Class getReturnType() {
            return beast.tracer.trace.GeneralizedSteppingStoneSamplingAnalysis.class;
        }
