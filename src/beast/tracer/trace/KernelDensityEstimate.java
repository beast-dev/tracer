...
import beast.tracer.trace.DensityEstimate;
...
//        }
    ...
    public static void main(String[] args) {
    	...
    	beast.tracer.trace.KernelDensityEstimate kdeTest = new beast.tracer.trace.KernelDensityEstimate("Gaussian", samples, 512);
