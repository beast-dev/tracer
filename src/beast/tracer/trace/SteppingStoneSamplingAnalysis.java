    ...
    public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
    	...
    	public Object parseXMLObject(XMLObject xo) throws XMLParseException {
    		...
    		try {
                ...
                beast.tracer.trace.SteppingStoneSamplingAnalysis analysis = new beast.tracer.trace.SteppingStoneSamplingAnalysis(likelihoodName, sampleLogLikelihood, sampleTheta);
        ...
        public Class getReturnType() {
            return beast.tracer.trace.SteppingStoneSamplingAnalysis.class;
        }
