...
public class TraceAnalysis {
     ...
     * @throws IOException if general error reading file
     * @throws TraceException      if trace file in wrong format or corrupted
     */
    public static LogFileTraces analyzeLogFile(String fileName, int burnin) throws IOException, TraceException {
    ...
    public static TraceList report(String fileName) throws IOException, TraceException {
        return report(fileName, -1, null);
    }

    public static TraceList report(String fileName, int burnin, String likelihoodName) throws IOException, TraceException {
