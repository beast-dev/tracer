...
package beast.tracer.app;

import jam.framework.*;
import dr.app.util.OSType;
import beast.tracer.ui.frame.TracerFrame;
...
public class TracerApp extends MultiDocApplication {
    ...
    public TracerApp(String nameString, String aboutString, Icon icon,
        ...
        super(new beast.tracer.ui.frame.TracerMenuBarFactory(), nameString, aboutString, icon, websiteURLString, helpURLString);

        addPreferencesSection(new beast.tracer.ui.frame.GeneralPreferencesSection());
    }
    ...
    static public void main(String[] args) {
        ...
        try {
            java.net.URL url = TracerApp.class.getResource("../ui/images/Tracer.png");
            Icon icon = null;
