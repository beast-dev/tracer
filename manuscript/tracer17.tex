...
Other packages are available for the post-processing of MCMC samples and are largely complementary to \tracer\. The R package `coda' \citep{plummer2006coda} provides some of the functionality of \tracer\ within the R programming environment. `AWTY' \citep{nylander2007awty} explores the convergence of the phylogenetic tree parameter itself across multiple MCMC runs.
